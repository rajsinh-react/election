...
var maybeReactUseId2 = React16["useId".toString()];
...
function useIsFocusVisible2() {
  const ref = React22.useCallback((node) => {
    if (node != null) {
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime5.jsx)(React29.Fragment, {
...
function FocusTrap(props) {
  ...
  const handleRef = useForkRef2(children.ref, rootRef);
...
var Portal = React49.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef2(React49.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default2(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime13.jsx)(React49.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime13.jsx)(React49.Fragment, {
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(React63.Fragment, {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime28.jsx)(React73.Fragment, {
...
var Select = React73.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsxs)(React73.Fragment, {
...
var Slider = React75.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime31.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime30.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime30.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime31.jsxs)(React75.Fragment, {
...
var TextareaAutosize = React93.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime46.jsxs)(React93.Fragment, {
...
function useTheme(defaultTheme5 = null) {
  const contextTheme = React99.useContext(ThemeContext);
...
function createBox(options = {}) {
  ...
  const Box2 = React101.forwardRef(function Box3(inProps, ref) {
...
var ThemeContext2 = React103.createContext(null);
if (true) {
...
function useTheme3() {
  const theme = React104.useContext(ThemeContext_default);
  if (true) {
    React104.useDebugValue(theme);
  }
  return theme;
}
...
var RtlContext = React106.createContext();
...
var PropsContext = React107.createContext(void 0);
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React110.useCallback((mode) => {
  ...
  const setColorScheme = React110.useCallback((value) => {
    if (!value) {
      setState((currentState) => {
        try {
  ...
  const handleMediaQuery = React110.useCallback((event) => {
  ...
  const mediaListener = React110.useRef(handleMediaQuery);
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React111.createContext(void 0);
  if (true) {
    ColorSchemeContext.displayName = "ColorSchemeContext";
  }
  const useColorScheme2 = () => {
    const value = React111.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider2(props) {
    ...
    const hasMounted = React111.useRef(false);
    const upperTheme = useTheme3();
    const ctx = React111.useContext(ColorSchemeContext);
    ...
    const element = (0, import_jsx_runtime59.jsxs)(React111.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime59.jsxs)(React111.Fragment, {
  ...
  true ? CssVarsProvider2.propTypes = {
     ...
     */
    attribute: import_prop_types47.default.string,
    /**
     * The component tree.
     */
     ...
     */
    colorSchemeNode: import_prop_types47.default.any,
    /**
     * The CSS selector for attaching the generated custom properties
     */
    colorSchemeSelector: import_prop_types47.default.string,
    /**
     * localStorage key used to store `colorScheme`
     */
    colorSchemeStorageKey: import_prop_types47.default.string,
    /**
     * The initial color scheme used.
     */
    defaultColorScheme: import_prop_types47.default.oneOfType([import_prop_types47.default.string, import_prop_types47.default.object]),
    /**
     * The initial mode used.
     */
    defaultMode: import_prop_types47.default.string,
    /**
     * If `true`, the provider creates its own context and generate stylesheet as if it is a root `CssVarsProvider`.
     */
    disableNestedContext: import_prop_types47.default.bool,
    /**
     * If `true`, the style sheet won't be generated.
     *
     * This is useful for controlling nested CssVarsProvider behavior.
     */
    disableStyleSheetGeneration: import_prop_types47.default.bool,
    /**
     * Disable CSS transitions when switching between modes or color schemes.
     */
    disableTransitionOnChange: import_prop_types47.default.bool,
    /**
     * The document to attach the attribute to.
     */
    documentNode: import_prop_types47.default.any,
    /**
     * The key in the local storage used to store current color scheme.
     */
    modeStorageKey: import_prop_types47.default.string,
    /**
     * The window that attaches the 'storage' event listener.
     * @default window
     */
    storageWindow: import_prop_types47.default.any,
    /**
...
function createContainer(options = {}) {
  ...
  const Container2 = React112.forwardRef(function Container3(inProps, ref) {
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React113.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React113.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React113.useContext(GridOverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime61.jsx)(GridRoot, _extends({
      ...
      children: React113.Children.map(children, (child) => {
        if (React113.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
function createStack(options = {}) {
  ...
  const Stack2 = React114.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
function getCheckboxUtilityClass(slot) {
  return generateUtilityClass4("MuiCheckbox", slot);
}
var checkboxClasses = generateUtilityClasses4("MuiCheckbox", ["root", "checkbox", "action", "input", "label", "checked", "disabled", "focusVisible", "indeterminate", "colorPrimary", "colorDanger", "colorNeutral", "colorSuccess", "colorWarning", "colorContext", "sizeSm", "sizeMd", "sizeLg", "variantOutlined", "variantSoft", "variantSolid"]);
...
function getSvgIconUtilityClass(slot) {
  return generateUtilityClass4("MuiSvgIcon", slot);
}
var svgIconClasses = generateUtilityClasses4("MuiSvgIcon", ["root", "colorInherit", "colorPrimary", "colorNeutral", "colorDanger", "colorSuccess", "colorWarning", "fontSizeInherit", "fontSizeXs", "fontSizeSm", "fontSizeMd", "fontSizeLg", "fontSizeXl", "fontSizeXl2", "fontSizeXl3", "fontSizeXl4", "sizeSm", "sizeMd", "sizeLg"]);

// node_modules/@mui/joy/SvgIcon/SvgIcon.js
var import_jsx_runtime65 = __toESM(require_jsx_runtime());
var import_jsx_runtime66 = __toESM(require_jsx_runtime());
var _excluded43 = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox", "size", "slots", "slotProps"];
var useUtilityClasses24 = (ownerState) => {
  ...
  const slots = {
    root: ["root", color2 && color2 !== "inherit" && `color${capitalize(color2)}`, size3 && `size${capitalize(size3)}`, fontSize2 && `fontSize${capitalize(fontSize2)}`]
  };
...
var SvgIcon = React117.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React117.isValidElement(children) && children.type === "svg";
  const ownerState = _extends({}, props, {
    color: color2,
    component,
    size: size3,
...
true ? SvgIcon.propTypes = {
   ...
   */
  color: import_prop_types54.default.oneOfType([import_prop_types54.default.oneOf(["danger", "inherit", "neutral", "primary", "success", "warning"]), import_prop_types54.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   */
  fontSize: import_prop_types54.default.oneOfType([import_prop_types54.default.oneOf(["inherit", "lg", "md", "sm", "xl", "xl2", "xl3", "xl4", "xs"]), import_prop_types54.default.string]),
  /**
...
function createSvgIcon(path, displayName) {
  ...
  return React118.memo(React118.forwardRef(Component));
}

// node_modules/@mui/joy/internal/svg-icons/Check.js
var import_jsx_runtime68 = __toESM(require_jsx_runtime());
var Check_default = createSvgIcon((0, import_jsx_runtime68.jsx)("path", {
...
var HorizontalRule_default = createSvgIcon((0, import_jsx_runtime69.jsx)("path", {
...
var TypographyNestedContext = React121.createContext(false);
if (true) {
  TypographyNestedContext.displayName = "TypographyNestedContext";
}
var TypographyInheritContext = React121.createContext(false);
if (true) {
...
var Typography = React121.forwardRef(function Typography2(inProps, ref) {
  var _inProps$color;
  ...
  const nesting = React121.useContext(TypographyNestedContext);
  const inheriting = React121.useContext(TypographyInheritContext);
  ...
  return (0, import_jsx_runtime70.jsx)(TypographyNestedContext.Provider, {
    value: true,
    children: (0, import_jsx_runtime71.jsxs)(SlotRoot, _extends({}, rootProps, {
      ...
      })), hasSkeleton ? React121.cloneElement(children, {
...
true ? Typography.propTypes = {
   ...
   * @default false
   */
  gutterBottom: import_prop_types55.default.bool,
  /**
   ...
   * }
   */
  levelMapping: import_prop_types55.default.object,
  /**
   ...
   * The system color.
   */
  textColor: import_prop_types55.default.any,
  /**
...
var FormControlContext2 = React122.createContext(void 0);
if (true) {
...
var _excluded45 = ["checked", "uncheckedIcon", "checkedIcon", "label", "defaultChecked", "disabled", "disableIcon", "overlay", "id", "indeterminate", "indeterminateIcon", "name", "onBlur", "onChange", "onFocus", "onFocusVisible", "readOnly", "required", "value", "color", "variant", "size", "component", "slots", "slotProps"];
var useUtilityClasses26 = (ownerState) => {
  ...
  const slots = {
    root: ["root", checked && "checked", disabled && "disabled", focusVisible && "focusVisible", variant && `variant${capitalize(variant)}`, color2 && `color${capitalize(color2)}`, size3 && `size${capitalize(size3)}`],
    checkbox: [
      "checkbox",
      checked && "checked",
...
var CheckboxRoot = styled_default2("span", {
  name: "JoyCheckbox",
  slot: "Root",
  overridesResolver: (props, styles2) => styles2.root
})(({
...
var CheckboxCheckbox = styled_default2("span", {
  name: "JoyCheckbox",
  slot: "Checkbox",
...
var CheckboxAction = styled_default2("span", {
  name: "JoyCheckbox",
  slot: "Action",
...
var CheckboxInput = styled_default2("input", {
  name: "JoyCheckbox",
  slot: "Input",
...
var CheckboxLabel = styled_default2("label", {
  name: "JoyCheckbox",
  slot: "Label",
...
var defaultCheckedIcon = (0, import_jsx_runtime72.jsx)(Check_default, {});
var defaultIndeterminateIcon = (0, import_jsx_runtime72.jsx)(HorizontalRule_default, {});
var Checkbox = React123.forwardRef(function Checkbox2(inProps, ref) {
  ...
  const color2 = inProps.color || (formControl != null && formControl.error ? "danger" : (_formControl$color = formControl == null ? void 0 : formControl.color) != null ? _formControl$color : colorProp);
  const activeColor = color2 || "primary";
  const inactiveColor = color2 || "neutral";
  const ownerState = _extends({}, props, {
    checked,
    disabled,
    disableIcon,
  ...
  return (0, import_jsx_runtime73.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime73.jsxs)(SlotCheckbox, _extends({}, checkboxProps, {
      children: [(0, import_jsx_runtime72.jsx)(SlotAction, _extends({}, actionProps, {
        children: (0, import_jsx_runtime72.jsx)(SlotInput, _extends({}, inputProps))
      })), icon]
    })), label && (0, import_jsx_runtime72.jsx)(TypographyNestedContext.Provider, {
      value: true,
      children: (0, import_jsx_runtime72.jsx)(SlotLabel, _extends({}, labelProps, {
        children: label
      }))
    })]
  }));
...
true ? Checkbox.propTypes = {
  ...
  slotProps: import_prop_types56.default.shape({
    ...
    checkbox: import_prop_types56.default.oneOfType([import_prop_types56.default.func, import_prop_types56.default.object]),
  ...
  slots: import_prop_types56.default.shape({
    ...
    checkbox: import_prop_types56.default.elementType,
